...
class NoticiaController extends Controller
{
    ...
    public function index()
    {
        ...
        $noticias = Noticia::orderByDesc("crete_at")->limit(10)->get();
        ...
        $noticias = Cache::remember("dez_primeiras_noticias", 15, function() use ($noticias){
            return  Noticia::orderByDesc("crete_at")->limit(10)->get();
        });
